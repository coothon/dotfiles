...
local theme = beautiful.init("/home/guy/.config/awesome/themes/nord/theme.lua")
...
awful.screen.connect_for_each_screen(function(s)
    ...
    local invis_sep_wid = wibox.widget {
        opacity = 0,
	forced_width = 50,
	...
	style = {
	    ...
	    shape_border_color = beautiful.border_marked,
    ...
    local mid_sep_wid = wibox.widget {
	opacity = 0.5,
	color = beautiful.fg_normal,
    ...
    local edge_sep_wid = wibox.widget {
        opacity = 0.0,
        forced_width = 5,
        widget = wibox.widget.separator,
    }
	...
	mytextclock,
	    ...
	    --spotify_widget({
		    ...
		    --pause_icon = '/usr/share/icons/Papirus-Dark/24x24/categories/spotify.svg',
...
-- Custom keybindings
	...
	traywidget:set_screen(awful.screen.focused()) end,
	{description = "move systray to screen", group = "awesome"}),
    awful.key({ modkey, "Shift" }, "p", function () awful.util.spawn("brave") end,
        {description = "spawn brave browser", group = "launcher"}),
    awful.key({ modkey, }, "z", function () awful.spawn.with_shell("boomer") end,
        {description = "zoom in", group = "launcher"}),
    awful.key({ modkey, "Shift" }, "o", function () awful.util.spawn("discord-canary") end,
        {description = "spawn discord", group = "launcher"}),
    awful.key({ modkey, }, "o", function () awful.spawn.with_shell("alacritty -e sh -c \"cd /home/guy/Music/ && ./play.sh\" && :") end,
        {description = "spawn custom script for playing music", group = "launcher"}),
    awful.key({ modkey, "Shift" }, "t", function () awful.spawn.with_shell("alacritty -e lf") end,
        {description = "spawn file manager (lf)", group = "launcher"}),
    awful.key({ modkey, "Shift" }, "s", function () awful.util.spawn("steam-native") end,
        {description = "spawn steam (native)", group = "launcher"}),
    awful.key({ modkey, }, "e", function () awful.util.spawn("emacs") end,
        {description = "spawn emacs", group = "launcher"}),
    awful.key({ modkey, }, "F4", function () awful.spawn.with_shell("pkexec openrc-shutdown -p now && :") end,
        {description = "instant, safe shutdown", group = "custom"}),
    awful.key({ modkey, "Shift" }, "F4", function () awful.spawn.with_shell("pkexec reboot && :") end,
        {description = "instant, safe reboot", group = "custom"}),
    awful.key({ modkey, "Shift" }, "d", function () awful.spawn.with_shell("SAL_DISABLEGL=0 SAL_FORCESKIA=1 SAL_SKIA=vulkan GDK_DPI_SCALE=1.5 SAL_USE_VCLPLUGIN=gtk4 libreoffice7.5 --nologo --writer") end,
        {description = "spawn libreoffice writer", group = "launcher"}),
    ...
    function()
      ...
      {description = "toggle visibility of all tags", group = "custom"}
    ),
...
-- Default keybingings
    ...
    -- Menubar
    awful.key({ modkey }, "p", function() awful.spawn("/home/guy/.config/rofi/launchers/type-1/launcher.sh") end,
...
-- Get the list of files from a directory. Must be all images or folders and non-empty. 
    ...
    wallpaperList = scanDir("/home/guy/.config/awesome/random_wallpapers/")

-- Apply a random wallpaper on startup.
    awful.spawn.with_shell("feh --no-fehbg --bg-fill " .. wallpaperList[math.random(1, #wallpaperList)])
...
-- }}}
-- autostart
    awful.spawn.with_shell("pidof pipewire || pipewire")
    awful.spawn.with_shell("pidof wireplumber || wireplumber")
    awful.spawn.with_shell("pidof pipewire-pulse || pipewire-pulse")
